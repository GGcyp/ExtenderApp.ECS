...
namespace ExtenderApp.ECS.Queries
{
    ...
    public readonly struct EntityQuery
    {
        ...
        /// </summary>
        internal EntityQueryCore Core { get; }
        ...
        internal EntityQuery(EntityQueryCore core)
        {
            Core = core;
        }
    ...
    {
        private readonly EntityQueryCore _core;
        ...
        internal EntityQuery(EntityQueryCore core, bool skipUnchanged = false)
        {
            _core = core;
