...
namespace ExtenderApp.ECS
{
    ...
    public partial class World
    {
        ...
        /// <returns>用于链式调用的 <see cref="EntityComponentOperation" />。</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EntityComponentOperation AddComponent<T>(Entity entity) where T : struct
        ...
        /// </remarks>
        public void SetSharedComponent<T>(in T value) where T : struct
        {
        ...
        public bool TryGetSharedComponent<T>(out T value) where T : struct
        ...
        public bool HasSharedComponent<T>() where T : struct
        ...
        public bool RemoveSharedComponent<T>() where T : struct
        {
            ThrowIfNotMainThread();
