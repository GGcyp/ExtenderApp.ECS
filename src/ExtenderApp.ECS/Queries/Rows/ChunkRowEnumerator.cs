...
{
    internal struct ChunkRowEnumerator
    {
        private ChunkEntityEnumerator entityEnumerator;

        public Entity Current => entityEnumerator.Current;

        public ChunkRowEnumerator(ChunkEntityEnumerator entityEnumerator) => this.entityEnumerator = entityEnumerator;

        public bool MoveNext() => entityEnumerator.MoveNext();
    }

    internal struct ChunkRowEnumerator<T1>
    {
        private ChunkEnumerator<T1> enum1;
        private ChunkEntityEnumerator entityEnumerator;
        public EntityQueryRow<T1> Current => new(entityEnumerator.Current, enum1.Current);

        public ChunkRowEnumerator(ChunkEnumerator<T1> enum1, ChunkEntityEnumerator entityEnumerator)
        {
            this.enum1 = enum1;
    ...
    internal struct ChunkRowEnumerator<T1, T2>
    {
        private ChunkEnumerator<T1> enum1;
        ...
        public ChunkRowEnumerator(ChunkEnumerator<T1> enum1, ChunkEnumerator<T2> enum2, ChunkEntityEnumerator entityEnumerator)
        {
            this.enum1 = enum1;
            this.enum2 = enum2;
            this.entityEnumerator = entityEnumerator;
    ...
    internal struct ChunkRowEnumerator<T1, T2, T3>
    {
        private ChunkEnumerator<T1> enum1;
        private ChunkEnumerator<T2> enum2;
        ...
        public ChunkRowEnumerator(ChunkEnumerator<T1> enum1, ChunkEnumerator<T2> enum2, ChunkEnumerator<T3> enum3, ChunkEntityEnumerator entityEnumerator)
        {
            this.enum1 = enum1;
            this.enum2 = enum2;
            this.enum3 = enum3;
    ...
    internal struct ChunkRowEnumerator<T1, T2, T3, T4>
    {
        private ChunkEnumerator<T1> enum1;
        private ChunkEnumerator<T2> enum2;
        private ChunkEnumerator<T3> enum3;
        ...
        public ChunkRowEnumerator(ChunkEnumerator<T1> enum1, ChunkEnumerator<T2> enum2, ChunkEnumerator<T3> enum3, ChunkEnumerator<T4> enum4, ChunkEntityEnumerator entityEnumerator)
        {
            this.enum1 = enum1;
            this.enum2 = enum2;
            this.enum3 = enum3;
    ...
    internal struct ChunkRowEnumerator<T1, T2, T3, T4, T5>
    {
        private ChunkEnumerator<T1> enum1;
        private ChunkEnumerator<T2> enum2;
        private ChunkEnumerator<T3> enum3;
        ...
        public ChunkRowEnumerator(ChunkEnumerator<T1> enum1, ChunkEnumerator<T2> enum2, ChunkEnumerator<T3> enum3, ChunkEnumerator<T4> enum4, ChunkEnumerator<T5> enum5, ChunkEntityEnumerator entityEnumerator)
        {
            this.enum1 = enum1;
            this.enum2 = enum2;
            this.enum3 = enum3;
